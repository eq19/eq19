...
We are going to assign prime identity as a per IREE model that attempts to stimulate a quantum field model called eQuantum for the four (4) known fundamental forces.
