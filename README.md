...
We are going to assign prime identity as per the IREE model that attempts to stimulate a quantum field model called **eQuantum** for [the four (4) known fundamental forces](https://en.wikipedia.org/wiki/Fundamental_interaction).
