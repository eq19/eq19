...
Assign prime identity as _Standard Model_ per the IREE's plan that attempts to stimulate a quantum field model called **eQuantum** for [the four (4) known fundamental forces](https://en.wikipedia.org/wiki/Fundamental_interaction).
